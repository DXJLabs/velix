...
export function createAppStore({
  ...
  const state = {
    ...
    walletSource: demoRuntimeMode ? "Demo" : "",
    helperVerified: false,
    walletInitState: "idle",
    walletInitMessage: "Connect Ready Wallet",
    walletInitError: "",
    ...
    privacyRegistrationReadiness: "blocked",
    privacyRegistrationReadinessCode: "wallet",
    privacyRegistrationReason: "Connect Ready Wallet first.",
    privacyRegistrationActionStatus: "idle",
    privacyRegistrationTxHash: "",
    readyWallet: null,
    readyAccount: null,
    readyProvider: null,
    readyReadProvider: null,
